...
| **Enterprise adoption laptop** | [`docs/enterprise-client-testing.md`](docs/enterprise-client-testing.md) — Part A gates + Copilot paste; fetch raw URL on client machines |
